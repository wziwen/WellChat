package com.ziwenwen.wellchat.easemod;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    static final int ITEM_VOICE = 1;
    static final int ITEM_PICTURE = 2;
    static final int ITEM_LOCATION = 3;
    
    protected int[] itemStrings = { R.string.attach_video_call, R.string.attach_voice_call, R.string.attach_picture, R.string.attach_location };
    protected int[] itemdrawables = { R.drawable.ease_chat_image_selector, R.drawable.ease_chat_image_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector };
    protected int[] itemIds = { ITEM_VIDEO, ITEM_VOICE, ITEM_PICTURE, ITEM_LOCATION };
    ...
    protected void startVoiceCall() {
        if (!EMClient.getInstance().isConnected()) {
            Toast.makeText(getActivity(), "未连接服务器", Toast.LENGTH_SHORT).show();
        } else {
